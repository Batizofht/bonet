    ...
    <div className="relative w-full h-screen bg-cover bg-center overflow-hidden" style={{ backgroundImage: "url('/investment-bg.jpg')" }}>
      ...
      >
        ...
        <p className="text-lg text-gray-200 mt-4 max-w-2xl">
          Explore profitable investment sectors in Rwanda, from real estate and tourism to technology and agriculture. Unlock the potential for sustainable growth and economic success.
        </p>
      </motion.div>
