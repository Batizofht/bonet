...
import BookingOverlay from "./lasthotel";

const BookingDetails = ({ selectedHotel, checkInDate, checkOutDate, setCheckInDate, setCheckOutDate, setOpen, checked1, setChecked1, checked2, setChecked2 }) => {
