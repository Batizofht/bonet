...
//       try {
//         const res = await axios.get("https://api.bonet.rw/bonetBackend/backend/public/advertisements");
...
//     try {
//       const res = await axios.post("https://api.bonet.rw/bonetBackend/backend/public/customBooking", values);
//       //console.log(res);
