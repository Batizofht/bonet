...
//       try {
//         const res = await axios.get("https://api.bonet.rw:8443/bonetBackend/backend/public/advertisements");
...
//     try {
//       const res = await axios.post("https://api.bonet.rw:8443/bonetBackend/backend/public/customBooking", values);
//       //console.log(res);
