...
import BookingOverlay from './lasttransport';
// import BookingOverlay from "./lastapartment";

const BookingDetailsTransport = ({ selectedTransport, travelDate, returnDate, setTravelDate, setReturnDate, setOpen, checked1, setChecked1, checked2, setChecked2 }) => {
  ...
  const handleDecrement = (setter, currentValue) => {
    if (currentValue > 1) setter(currentValue - 1);
  };
...
export default BookingDetailsTransport;