      ...
      <div className="flex items-center bg-blue-100 p-6 rounded-2xl shadow-lg">
        ...
        <div className="w-1/2">
          ...
          <p className="text-lg text-gray-700 mt-2">
            Transform your business with our dedicated support team! Designed to
            streamline customer interactions, our team efficiently handles
            inquiries, guides users through booking processes, and assists with
            business registrations. With our intelligent response system, we
            reduce customer wait times by an impressive 60%, ensuring a seamless
