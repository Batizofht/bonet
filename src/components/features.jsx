...
const features = [
  {
    ...
    description:
      "Our AI chatbot assists with customer support, answering FAQs, handling bookings, and guiding users through business registration.",
  ...
  },
  {
    ...
    description:
      "The AI-driven booking system automates hotel, transport, and tour reservations, offering seamless scheduling and real-time updates.",
  ...
  },
  {
    ...
    description:
      "AI analyzes user behavior to offer personalized recommendations, enhancing user experience and engagement.",
  ...
  // },
  {
    ...
    description:
      "Enable hands-free customer interaction with an AI-powered voice assistant for answering queries and assisting users.",
...
const AIFeatures = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-gray-700 text-3xl font-bold">Our AI-Powered</h2>
